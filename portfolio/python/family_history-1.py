...
def print_death_age(people_dict):
    ...
    Return: nothing
    """
    for person_info in people_dict.values():
        name = person_info[0]
        birth_year = person_info[2]
        death_year = person_info[3]

        age = death_year - birth_year

        print(f"{name} {age} {death_year}")
    pass
...
def print_marriages(marriages_dict, people_dict):
    ...
    for marriage in marriages_dict.values():
        ...
        if husband_key in people_dict and wife_key in people_dict:
            ...
            husband_name = husband_info[0]
            husband_birth_year = husband_info[2]
            h_age_at_wedding = wedding_year - husband_birth_year

            wife_name = wife_info[0]
            wife_birth_year = wife_info[2]
            w_age_at_wedding = wedding_year - wife_birth_year

            print(
                f"{husband_name} {h_age_at_wedding} > {wedding_year} < {wife_name} {w_age_at_wedding}"
            )
    pass
