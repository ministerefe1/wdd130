...
width = float(input("Enter the tire width in millimeters: "))
...
# Calculate the volume in liters and display it
...
#         return volume
        ...
        #volume_liters = volume_cubic_meters
...
# class File:
#     @staticmethod
#     def file_txt(current_date, width, aspect_ratio, diameter, volume):
...
#         file_handler = File()
#         file_handler.file_txt(current_date, width, aspect_ratio, diameter, volume_liters)
